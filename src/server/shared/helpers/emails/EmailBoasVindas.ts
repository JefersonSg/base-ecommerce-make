...
export async function EmailBoasVindas({
  ...
  try {
    const response = await resend.emails.send({
      from: 'Loja Bless <contato@lojabless.com.br>',
      to: [to],
      ...
      html: `
        <div style="font-family: Arial, sans-serif; padding: 20px; color: #333;">
          ...
          <a href="https://lojabless.com.br" style="display:inline-block; padding:10px 20px; background:#d71920; color:#fff; border-radius:5px; text-decoration:none; font-weight:bold;">
            Ir para a Loja
          </a>
